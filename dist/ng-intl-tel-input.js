...
angular.module('ngIntlTelInput')
  .provider('ngIntlTelInput', ['ngIntlTelInputData',
    function (ngIntlTelInputData) {
      var me = this;
      var props = {};
          ...
          init: {
            value: function (elm) {
              ...
              if(language) {
                ...
                switch(language) {
                  case 'fr': $.each(countryData, function (i, country) {
                    console.log(country);
                    country.name = 'Haha' + i;
                  }); break;
                  default: $.each(countryData, function (i, country) {
                    console.log(country);
                    country.name = 'Whatwhat' + 1;
                  }); break;
                }
              }
    ...
    function (ngIntlTelInput, $log, $window, $parse) {
      return {
        ...
        link: function (scope, elm, attr, ctrl) {
          ...
          // Initialize.
          ngIntlTelInput.init(elm, language);
